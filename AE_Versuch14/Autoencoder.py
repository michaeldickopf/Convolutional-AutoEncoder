...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.upsample2 = nn.Upsample(scale_factor=2, mode='nearest')  # Output: 16x64x72
...
# Testing function
def test_epoch(encoder, decoder, device, dataloader, loss_fn):    # Set evaluation mode for encoder and decoder
    encoder.eval()
    decoder.eval()
