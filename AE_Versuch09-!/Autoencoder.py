...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(16, 32, kernel_size=3, stride=2, padding=1)  # Output: 32x32x36
        self.conv3 = nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1)  # Output: 64x16x18
...
class Decoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.tconv1 = nn.ConvTranspose2d(64, 32, kernel_size=3, stride=2, padding=1,
                                         output_padding=1)  # Output: 32x32x36
        self.tconv2 = nn.ConvTranspose2d(32, 16, kernel_size=5, stride=2, padding=2,
                                         output_padding=1)  # Output: 16x64x72
        self.tconv3 = nn.ConvTranspose2d(16, 3, kernel_size=5, stride=2, padding=2,
                                         output_padding=1)  # Output: 3x128x144
