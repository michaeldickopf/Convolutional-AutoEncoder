...
P.optimizer = torch.optim.Adam(params_to_optimize, lr=P.lr, weight_decay=P.weight_decay)
...
def plot_original_vs_reconstructed(encoder, decoder, dataloader, device):
    ...
    with torch.no_grad():
        ...
        first_image = first_image.reshape(3, 64, 96)
        ...
        print('time spent for encoding and saving: {}'.format((timeSpent := saved_encoding - start_encoding)))
